...
contract MultiSignatureWallet {
    ...
    /// @dev Checks that at least one owner and one confirmation required and that there are not more confirmation requests than owners
    /// @param ownerCount is number of owners
